...
namespace _Code.Movement
{
    public class MovePointController : MonoBehaviour
    {
        ...
        [Header("Circlecast Parameters")]
        [SerializeField] private float _circleRadius = 1.0f;
        ...
        public bool CheckForFreeSpace(Vector2 displacementDirection, float circleRadius)
        {
            ...
            return !Physics2D.CircleCast((Vector2)transform.position + displacementDirection.ComponentMultiply((Vector2)transform.localScale), 
